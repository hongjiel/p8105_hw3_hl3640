...
From the plot, it seems that there is no apparent increasing or decreasing trend in average max temperature in January and in July in each station. There is an apparent outlier, which is the average max temperature in July in 1988 in one station.
